...
<template>
  <div class="inv-wrapper">
    <div class="inv-header">
      <h4 class="inv-subtitle">tu cuenta</h4>
      <h2 class="inv-title">Invitaciones de clan</h2>
    </div>

    <div v-if="loading" class="inv-empty">Cargando invitaciones...</div>

    <div v-else-if="!invitations.length" class="inv-empty">
      <i class="fas fa-envelope-open"></i>
      <p>No tienes invitaciones pendientes.</p>
    </div>

    <div v-else class="inv-list">
      <div v-for="inv in invitations" :key="inv._id" class="inv-card">
        <div class="inv-info">
          <div class="inv-main">
